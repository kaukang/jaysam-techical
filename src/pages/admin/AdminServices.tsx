...
export default function AdminServices() {
  return (
    <div className="flex flex-col items-center justify-center h-[60vh] text-center max-w-lg mx-auto">
      ...
      <h1 className="text-2xl font-bold text-[#082B52] mb-3">Services Module</h1>
      <p className="text-slate-500 mb-8 leading-relaxed">
        This module is currently under construction. In the next update, you will be able to manage the "Why Choose Us" features and services listed on your homepage.
      </p>
      <div className="bg-slate-50 border border-slate-200 p-4 rounded-lg text-sm text-left w-full text-slate-600">
        ...
        <ul className="list-disc pl-5 space-y-1">
          <li>Dynamic icon selector</li>
          <li>Service title & description editor</li>
          <li>Reorder services (drag & drop)</li>
        </ul>
      </div>
    </div>
  );
